...
public class StringEx {
  ...
  public static void ex2() {
    ...
    System.out.println(System.identityHashCode(str1));  // 참조 값 확인 (같음)
    System.out.println(System.identityHashCode(str2));  // 참조 값 확인 (같음)
  ...
  public static void ex3() {
    ...
    System.out.println(System.identityHashCode(str1));  // 참조 값 확인 (다름)
    System.out.println(System.identityHashCode(str2));  // 참조 값 확인 (다름)
  ...
  public static void ex4() {
    ...
    System.out.println(str1.equalsIgnoreCase(str2)); //true 출력
  ...
  public static void ex6() {
    ...
    System.out.println(str.charAt(2));  // l 출력
    System.out.println(str.charAt(3));  // l 출력
  ...
  public static void ex7() {
    ...
    System.out.println(str.indexOf(" "));     //5출력
    System.out.println(str.lastIndexOf(" ")); //11출력
    System.out.println(str.indexOf("r"));     //8출력
    System.out.println(str.lastIndexOf("l")); //15출력
  ...
  public static void ex8() {
    ...
    System.out.println(str.substring(0, spaceIndex));  // 0부터 5 이전까지 반환  = hello
    System.out.println(str.substring(spaceIndex + 1)); // 5+1 부터 끝까지 반환   = world
  ...
  public static void practice01() {
    ...
    System.out.println(uri.indexOf(contextPath));  // 21출력
    System.out.println(contextPath.length());      //  8출력
    System.out.println(mapping);                   // /list.do 출력
    
  }
  
  public static void practice02() {
    // charAt​(int index) 
    //문자열의 index 위치에 있는 글자를 'char' 타입으로 리턴한다. - index는 0부터 시작한다.  - 마지막 문자의 index는 '문자열 길이 - 1'이다.
